  ...
  public ngOnInit() {
    ...
    this.dataTable = this._factory.dataTable({
      ...
      tableColumns: [
        ...
        { prop: 'skilltype_name', name: 'Category', flexGrow: 2, sortable: false },
        { prop: 'skill_name', name: 'Skills', flexGrow: 2, sortable: false },
        { prop: 'sdmskill_value', name: 'Value', flexGrow: 2, sortable: false },
        { prop: 'end_contractproject', name: 'End date project', flexGrow: 2, sortable: false },
        { prop: 'sdm_notification', name: 'Notifikasi Kontrak', flexGrow: 2, cellTemplate: this.notif, sortable: false },
        { prop: 'sdm_id', name: 'Select', flexGrow: 2, cellTemplate: this.tableActionTemplate, sortable: false }
      ]
    });
